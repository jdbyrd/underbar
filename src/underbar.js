(function() {
  ...
  _.last = function(array, n) {
    return n === undefined ? array[array.length-1] : n === 0 ? Array(0) : array.slice(-n, array.length);
  };
  ...
  _.memoize = function(func) {
    ...
    return function(){
      ...
      if(args in called){
        ...
        return called[args] = func.apply(this, arguments);
      }
    }
  ...
  return _.reduce(array, function(shuffled, item){
    var random = getRandomInt(0, array.length);
    while(shuffled[random] !== undefined){
      random = getRandomInt(0, array.length);
    }
